...
export const getMovieCredits = async (movieId = null) => {
...
export const getMovieReviews = async (movieId = null, currentPage = 1) => {
  const url = `${BASE_URL}movie/${movieId}/reviews?api_key=${API_KEY}&language=en-US&page=${currentPage}`;
